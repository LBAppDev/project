...
export const assessmentSchema: SectionSchema[] = [
  {
    ...
    fields: [
      ...
      yesNoField('syncopeLipothymia', { fr: 'Syncope / lipothymie', en: 'Syncope / lipothymia', ar: 'إغماء / ما قبل الإغماء' }),
  ...
  },
  {
    ...
    fields: [
      ...
      yesNoField('lowerLimbEdemaUrinary', { fr: 'Oedeme des membres inferieur', en: 'Lower limb edema', ar: 'وذمة الأطراف السفلية' }),
      yesNoField('upperLimbEdemaUrinary', { fr: 'Oedeme des membres superieur', en: 'Upper limb edema', ar: 'وذمة الأطراف العلوية' }),
